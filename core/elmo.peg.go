...
func (p *ElmoGrammar) Init() {
	...
	_rules = [...]func() bool{
		...
		/* 20 LongStringLiteral <- <(BackTick LongStringChar* BackTick Spacing)> */
		func() bool {
			...
			l139:
				...
				depth--
				add(ruleLongStringLiteral, position138)
			}
			return true
		l137:
		...
		func() bool {
			...
			l145:
				depth--
				add(ruleLongStringChar, position144)
			}
			return true
		l143:
		...
		func() bool {
			...
			l150:
				depth--
				add(ruleLongEscape, position149)
			}
			return true
		l148:
