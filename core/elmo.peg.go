...
func (p *ElmoGrammar) Init() {
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l125:
				depth--
				add(ruleStringChar, position124)
			}
			return true
		l123:
		...
		func() bool {
			...
			l133:
				...
				depth--
				add(ruleLongStringLiteral, position132)
			}
			return true
		l131:
